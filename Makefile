...
EXTRA=\
	mkfs.c ulib.c user.h cat.c echo.c forktest.c grep.c kill.c test_reent_lock.c\
	ln.c ls.c mkdir.c rm.c stressfs.c usertests.c wc.c zombie.c test_sys_count.c\
	printf.c umalloc.c\
